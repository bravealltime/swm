              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3 max-h-[700px] overflow-y-auto pr-1">
                  {displayedCounters.map((counter, idx) => (
                    <div
                      key={counter.id}
                      className="rounded-2xl border border-white/[0.08] bg-[#0a0f19]/80 backdrop-blur-xl p-4 sm:p-5 hover:border-blue-500/40 transition-all space-y-3 shadow-lg"
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-white/[0.06]">
                        <div className="flex items-center gap-3">
                          <span className="w-6 h-6 rounded-lg bg-white/[0.04] border border-white/10 font-mono text-xs font-bold text-slate-300 flex items-center justify-center">
                            #{idx + 1}
                          </span>
                          <div className="flex items-center gap-2">
