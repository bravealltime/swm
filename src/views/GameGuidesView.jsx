          ...
          {filteredGuides.map((guide) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-3 pt-2 border-t border-[#182333] flex items-center justify-between text-[11px]">
                  <span className="text-slate-500 font-mono">{guide.avgClearTime}</span>
              ...
              {activeGuide.recommendedTeam.map((mem, idx) => (
                ...
                >
                  <div>
                    ...
                    <div className="text-[11px] text-slate-400">{mem.role}</div>
                  </div>
                  <div className="text-right shrink-0">
                    <span className="px-2 py-0.5 rounded text-[11px] font-mono font-bold bg-[#152030] text-cyan-300 border border-[#1d2b3f]">
                      รูน: {mem.rune}
                    </span>
                  </div>
                </div>
