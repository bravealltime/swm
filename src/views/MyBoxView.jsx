...
import {
  ...
  Download, Trophy, Layers, Eye, EyeOff, Radio, Plug, RotateCcw } from 'lucide-react';
...
function Overview({ box, mdc, owned, onTab, onOpenUnit }) {
...
function BoxGrid({ box, onOpenUnit }) {
