...
export default function QuizView({ onNavigate }) {
  ...
  return (
    <div className="space-y-5 max-w-3xl mx-auto pb-16 animate-fadeIn">
      ...
      <p className="text-[11px] text-slate-500">โจทย์สุ่มจากมอนสเตอร์ที่ถูกดราฟต์ในการแข่งขันระดับ Guardian ซีซั่นนี้ ชุดใหม่ทุกวันเวลา 00:00 น. — ผลเก็บในเครื่องนี้เท่านั้น</p>
    </div>
  );
}
